...
namespace ToolGood.ReadyGo.NPoco.Linq
{
    ...
    public interface IAsyncQueryResultProvider<T>
    {
        ...
        /// <param name="cancellationToken">取消令牌。</param>
        /// <returns>存在返回 true，否则返回 false。</returns>
        Task<bool> Exists_Async(CancellationToken cancellationToken = default);
        /// <summary>
        ...
        /// <param name="cancellationToken">取消令牌。</param>
        /// <returns>存在返回 true，否则返回 false。</returns>
        Task<bool> Exists_Async(Expression<Func<T, bool>> whereExpression, CancellationToken cancellationToken = default);
        /// <summary>
        /// 异步分页返回结果。
        /// </summary>
        ...
        Task<List<T>> SelectPage_Async(int page, int pageSize, CancellationToken cancellationToken = default);
        /// <summary>
        /// 异步投影返回结果列表。
        /// </summary>
    ...
    public interface IQueryResultProvider<T>
    {
        ...
        /// <param name="pageSize">每页大小。</param>
        /// <returns>当前页数据列表。</returns>
        List<T> SelectPage(int page, int pageSize);
        /// <summary>
        /// 投影返回结果列表。
        /// </summary>
        /// <typeparam name="T2">投影结果类型。</typeparam>
    ...
    public interface IQueryProvider<T> : IQueryResultProvider<T>
    {
        ...
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhere(bool condition, Expression<Func<T, bool>> predicate);
        /// <summary>
        /// 条件成立时添加 Order By。
        /// </summary>
        /// <param name="condition">条件开关，为 true 时生效。</param>
        /// <param name="column">排序字段表达式。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueOrderBy(bool condition, Expression<Func<T, object>> column);
        /// <summary>
        ...
        /// <param name="column">排序字段表达式。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueOrderByDescending(bool condition, Expression<Func<T, object>> column);
        /// <summary>
        ...
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereExists(string sql, params object[] args);
        /// <summary>
        ...
        /// <param name="args">SQL 参数。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotExists(string sql, params object[] args);
        /// <summary>
        ...
        /// <param name="args">SQL 参数。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereExists(bool condition, string sql, params object[] args);
        /// <summary>
        ...
        /// <param name="args">SQL 参数。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotExists(bool condition, string sql, params object[] args);
        /// <summary>
        ...
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereIn<TValue>(string column, IEnumerable<TValue> values);
        /// <summary>
        ...
        /// <param name="values">值集合。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereIn<TValue>(Expression<Func<T, TValue>> field, IEnumerable<TValue> values);
        /// <summary>
        ...
        /// <param name="values">值集合。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereIn<TValue>(bool condition, string column, IEnumerable<TValue> values);
        /// <summary>
        ...
        /// <param name="values">值集合。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereIn<TValue>(bool condition, Expression<Func<T, TValue>> field, IEnumerable<TValue> values);
        /// <summary>
        ...
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereLike(string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容（自动加前后 %）。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereLike<TValue>(Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereLike(bool condition, string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereLike<TValue>(bool condition, Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="values">值集合。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotIn<TValue>(string column, IEnumerable<TValue> values);
        /// <summary>
        ...
        /// <param name="values">值集合。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotIn<TValue>(Expression<Func<T, TValue>> field, IEnumerable<TValue> values);
        /// <summary>
        ...
        /// <param name="values">值集合。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotIn<TValue>(bool condition, string column, IEnumerable<TValue> values);
        /// <summary>
        ...
        /// <param name="values">值集合。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotIn<TValue>(bool condition, Expression<Func<T, TValue>> field, IEnumerable<TValue> values);
        /// <summary>
        ...
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereLikeStart(string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereLikeStart<TValue>(Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereLikeStart(bool condition, string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereLikeStart<TValue>(bool condition, Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereLikeEnd(string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereLikeEnd<TValue>(Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereLikeEnd(bool condition, string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereLikeEnd<TValue>(bool condition, Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容（自动加前后 %）。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotLike(string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容（自动加前后 %）。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotLike<TValue>(Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotLike(bool condition, string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotLike<TValue>(bool condition, Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容（自动加后缀 %）。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotLikeStart(string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotLikeStart<TValue>(Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotLikeStart(bool condition, string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotLikeStart<TValue>(bool condition, Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容（自动加前缀 %）。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotLikeEnd(string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> WhereNotLikeEnd<TValue>(Expression<Func<T, TValue>> field, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotLikeEnd(bool condition, string column, string pattern);
        /// <summary>
        ...
        /// <param name="pattern">匹配内容。</param>
        /// <returns>当前查询器。</returns>
        IQueryProvider<T> IfTrueWhereNotLikeEnd<TValue>(bool condition, Expression<Func<T, TValue>> field, string pattern);
    }
