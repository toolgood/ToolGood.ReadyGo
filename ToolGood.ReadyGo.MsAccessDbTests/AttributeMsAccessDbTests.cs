...
{
    /// <summary>
    /// byte[] 保存与读取（基于 Access）
    /// </summary>
    [Collection("MsAccessDb")]
    public class ByteArrayMsAccessDbTests
    {
    ...
    /// <summary>
    /// [Numeric2Int] / [Numeric2Long] 属性：小数转整数存储（基于 Access）
    /// </summary>
    [Collection("MsAccessDb")]
    public class Decimal2MsAccessDbTests
    {
        private static MsAccessDbTestDb CreateTable()
        {
            var db = MsAccessDbTestDb.Create();
    ...
    /// <summary>
    /// [NumericArray] 属性：数值数组以 byte[] 保存（基于 Access）
    /// </summary>
    [Collection("MsAccessDb")]
    public class NumericArrayMsAccessDbTests
    {
        private static MsAccessDbTestDb CreateTable()
        {
            var db = MsAccessDbTestDb.Create();
