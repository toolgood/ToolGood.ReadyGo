...
{
    /// <summary>
    /// SqlHelper 同步方法单元测试（基于 Firebird）
    /// </summary>
    [Collection("FirebirdDb")]
    public class SqlHelperFirebirdDbTests
    {
        #region Insert
        ...
        {
            using var db = FirebirdDbTestDb.Create();
    ...
    /// <summary>
    /// SqlHelper 异步方法单元测试（基于 Firebird）
    /// </summary>
    [Collection("FirebirdDb")]
    public class SqlHelperFirebirdDbAsyncTests
    {
        [Fact]
