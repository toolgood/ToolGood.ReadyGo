...
{
    /// <summary>
    /// byte[] 保存与读取（基于 Firebird）
    /// </summary>
    [Collection("FirebirdDb")]
    public class ByteArrayFirebirdDbTests
    {
    ...
    /// <summary>
    /// [Numeric2Int] / [Numeric2Long] 属性：小数转整数存储（基于 Firebird）
    /// </summary>
    [Collection("FirebirdDb")]
    public class Decimal2FirebirdDbTests
    {
        private static FirebirdDbTestDb CreateTable()
        {
            var db = FirebirdDbTestDb.Create();
    ...
    /// <summary>
    /// [NumericArray] 属性：数值数组以 byte[] 保存（基于 Firebird）
    /// </summary>
    [Collection("FirebirdDb")]
    public class NumericArrayFirebirdDbTests
    {
        private static FirebirdDbTestDb CreateTable()
        {
            var db = FirebirdDbTestDb.Create();
