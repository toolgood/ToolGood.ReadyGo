...
{
    /// <summary>
    /// byte[] 保存与读取（基于 DuckDB）
    /// </summary>
    [Collection("DuckDb")]
    public class ByteArrayDuckDbTests
    {
    ...
    /// <summary>
    /// [Numeric2Int] / [Numeric2Long] 属性：小数转整数存储（基于 DuckDB）
    /// </summary>
    [Collection("DuckDb")]
    public class Decimal2DuckDbTests
    {
        private static DuckDbTestDb CreateTable()
        {
            var db = DuckDbTestDb.Create();
    ...
    /// <summary>
    /// [NumericArray] 属性：数值数组以 byte[] 保存（基于 DuckDB）
    /// </summary>
    [Collection("DuckDb")]
    public class NumericArrayDuckDbTests
    {
        private static DuckDbTestDb CreateTable()
        {
            var db = DuckDbTestDb.Create();
