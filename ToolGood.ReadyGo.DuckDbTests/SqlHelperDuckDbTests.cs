...
{
    /// <summary>
    /// SqlHelper 同步方法单元测试（基于 DuckDB）
    /// </summary>
    [Collection("DuckDb")]
    public class SqlHelperDuckDbTests
    {
        #region Insert
        ...
        {
            using var db = DuckDbTestDb.Create();
    ...
    /// <summary>
    /// SqlHelper 异步方法单元测试（基于 DuckDB）
    /// </summary>
    [Collection("DuckDb")]
    public class SqlHelperDuckDbAsyncTests
    {
        [Fact]
