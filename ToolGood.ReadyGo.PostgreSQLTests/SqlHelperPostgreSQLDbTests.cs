...
{
    /// <summary>
    /// SqlHelper 同步方法单元测试（基于 PostgreSQL）
    /// </summary>
    [Collection("PostgreSQLDb")]
    public class SqlHelperPostgreSQLDbTests
    {
        #region Insert
        ...
        {
            using var db = PostgreSQLTestDb.Create();
    ...
    /// <summary>
    /// SqlHelper 异步方法单元测试（基于 PostgreSQL）
    /// </summary>
    [Collection("PostgreSQLDb")]
    public class SqlHelperPostgreSQLDbAsyncTests
    {
        [Fact]
