...
{
    /// <summary>
    /// byte[] 保存与读取（基于 PostgreSQL）
    /// </summary>
    [Collection("PostgreSQLDb")]
    public class ByteArrayPostgreSQLDbTests
    {
    ...
    /// <summary>
    /// [Numeric2Int] / [Numeric2Long] 属性：小数转整数存储（基于 PostgreSQL）
    /// </summary>
    [Collection("PostgreSQLDb")]
    public class Decimal2PostgreSQLDbTests
    {
        private static PostgreSQLTestDb CreateTable()
        {
            var db = PostgreSQLTestDb.Create();
    ...
    /// <summary>
    /// [NumericArray] 属性：数值数组以 byte[] 保存（基于 PostgreSQL）
    /// </summary>
    [Collection("PostgreSQLDb")]
    public class NumericArrayPostgreSQLDbTests
    {
        private static PostgreSQLTestDb CreateTable()
        {
            var db = PostgreSQLTestDb.Create();
