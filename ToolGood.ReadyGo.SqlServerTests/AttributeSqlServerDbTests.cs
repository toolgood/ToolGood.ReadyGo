...
{
    /// <summary>
    /// byte[] 保存与读取（基于 SQL Server）
    /// </summary>
    [Collection("SqlServerDb")]
    public class ByteArraySqlServerDbTests
    {
    ...
    /// <summary>
    /// [Numeric2Int] / [Numeric2Long] 属性：小数转整数存储（基于 SQL Server）
    /// </summary>
    [Collection("SqlServerDb")]
    public class Decimal2SqlServerDbTests
    {
        private static SqlServerTestDb CreateTable()
        {
            var db = SqlServerTestDb.Create();
    ...
    /// <summary>
    /// [NumericArray] 属性：数值数组以 byte[] 保存（基于 SQL Server）
    /// </summary>
    [Collection("SqlServerDb")]
    public class NumericArraySqlServerDbTests
    {
        private static SqlServerTestDb CreateTable()
        {
            var db = SqlServerTestDb.Create();
