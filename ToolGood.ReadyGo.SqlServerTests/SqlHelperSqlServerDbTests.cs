...
{
    /// <summary>
    /// SqlHelper 同步方法单元测试（基于 SQL Server）
    /// </summary>
    [Collection("SqlServerDb")]
    public class SqlHelperSqlServerDbTests
    {
        #region Insert
        ...
        {
            using var db = SqlServerTestDb.Create();
        ...
        public void Transaction_Commit()
        {
            ...
            using (var trans = helper.UseTransaction()) {
                helper.Execute("INSERT INTO [USERINFO] (NAME, AGE, REMARK, CREATETIME, MONEY, ISDELETE) VALUES ('事务1', 1, NULL, '2026-01-01', 1, 1)");
                trans.Complete();
            }
        ...
        public void Transaction_Rollback()
        {
            ...
            using (var trans = helper.UseTransaction()) {
                helper.Execute("INSERT INTO [USERINFO] (NAME, AGE, REMARK, CREATETIME, MONEY, ISDELETE) VALUES ('事务2', 1, NULL, '2026-01-01', 1, 1)");
                // 不调用 Complete，释放时应回滚
            }
    ...
    /// <summary>
    /// SqlHelper 异步方法单元测试（基于 SQL Server）
    /// </summary>
    [Collection("SqlServerDb")]
    public class SqlHelperSqlServerDbAsyncTests
    {
        [Fact]
