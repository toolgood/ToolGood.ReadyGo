...
{
    /// <summary>
    /// byte[] 保存与读取（基于 Oracle）
    /// </summary>
    [Collection("OracleDb")]
    public class ByteArrayOracleDbTests
    {
    ...
    /// <summary>
    /// [Numeric2Int] / [Numeric2Long] 属性：小数转整数存储（基于 Oracle）
    /// </summary>
    [Collection("OracleDb")]
    public class Decimal2OracleDbTests
    {
        private static OracleTestDb CreateTable()
        {
            var db = OracleTestDb.Create();
    ...
    /// <summary>
    /// [NumericArray] 属性：数值数组以 byte[] 保存（基于 Oracle）
    /// </summary>
    [Collection("OracleDb")]
    public class NumericArrayOracleDbTests
    {
        private static OracleTestDb CreateTable()
        {
            var db = OracleTestDb.Create();
