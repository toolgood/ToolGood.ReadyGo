...
namespace ToolGood.ReadyGo.Tests
{
    ...
    public class SqlHelperTests
    {
        ...
        public void ObjectCondition_Update_Set()
        {
            ...
            Assert.Equal(1, helper.Update<SimpleUser>(new { Age = 99 }, cond));
        ...
        public void ObjectCondition_Delete()
        {
            ...
            Assert.Equal(1, helper.Delete<SimpleUser>(new { Id = loaded.Id }));
        ...
        public void ObjectCondition_Update_NullSet_Throws()
        {
            ...
            // set 为 null 应抛出明确异常（Update 家族存在 string 重载，null 字面量会命中 string 重载，
        ...
        public void ObjectCondition_UpdateBy_OnlyUpdatesSpecifiedFields()
        {
            ...
            // 仅更新 Age，其余字段保持原值
            Assert.Equal(1, helper.Update<UserInfo>(
        ...
        public void ObjectCondition_UpdateBy_EmptyColumns_Throws()
        {
            ...
            Assert.Throws<ArgumentException>(() => helper.Update<UserInfo>(
